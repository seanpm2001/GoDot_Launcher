GoDot_Launcher
{ For Linux
Similar in style to the Minecraft launcher
Import GoDot application file
...
[Request] GoDot release collection

Upload a backup to archive.org

Storage: stored GoDot packages, upload manually, download via network, full edition (all GoDot versions included)

Purpose:
To fully install GoDot, customize the GoDot experience, and not just have it as an application in your file manager. On GNOME, this would make an app shortcut for GoDot with the GoDot logo, and also let you pin it to your dock

Benefits:

(personal) an easy to make, functional piece of software that will give me a good, functional program that is easy to maintain
[universal] an easier way to launch GoDot

Launcher:

Write in: Python, QML, Tcl
Modes:
Command Line (Python)
GUI (Python, QML or Python, Tcl (depending on the platform))

GoDot logo

Snapcraft edition: not a priority, but may exist unofficially
